...
const [dashboardData,setDashboarddData] = useState(null)
const {currency} =useContext(AppContext)

const fetchDashboardData =async ()=>{
  setDashboarddData(dummyDashboardData)
}
...
<table className='table-fied md:table-auto w-full overflow-hidden'>
